...
def sha_e(block_size, __op0, __op1, __op2, step):
    ...
    if __op0 == 1:
        eqn__constraints.append(xor_function(block_size,
                                             right_shift(in_var_v_e[3], 6), right_shift(in_var_d_e[3], 6), # 14 in SHA512
                                             right_shift(in_var_v_e[3], 11), right_shift(in_var_d_e[3], 11), # 18 in SHA512
                                             right_shift(in_var_v_e[3], 25), right_shift(in_var_d_e[3], 25), # 41 in SHA512
                                             in_var_v_b[0], in_var_d_b[0],
                                             right_shift(in_var_e[3], 6), # 14 in SHA512
                                             right_shift(in_var_e[3], 11), # 18 in SHA512
                                             right_shift(in_var_e[3], 25))) # 41 in SHA512
    if __op1 == 1:
...
def sha_a(block_size, __op3, __op4, __op5, step):
    ...
    if __op3:
        eqn__constraints.append(xor_function(block_size,
                                             right_shift(in_var_v_a[3], 2), right_shift(in_var_d_a[3], 2), # 28 in SHA512
                                             right_shift(in_var_v_a[3], 13), right_shift(in_var_d_a[3], 13), # 34 in SHA512
                                             right_shift(in_var_v_a[3], 22), right_shift(in_var_d_a[3], 22), # 39 in SHA512
                                             in_var_v_b[6], in_var_d_b[6],
                                             right_shift(in_var_a[3], 2), # 28 in SHA512
                                             right_shift(in_var_a[3], 13), # 34 in SHA512
                                             right_shift(in_var_a[3], 22))) # 39 in SHA512
    if __op4:
...
def sha2_value(block_size, fna0, fna1, step):
    ...
    for i in range(block_size):
        ...
        eqn__constraints.append("ASSERT constant_" + str(step) + "_" + str(block_size - i - 1) + " = 0bin%s;\n" % (
            bin(k_constant_256[step])[2:].zfill(32)[i])) # looks like filled by word size (64 in SHA512)
    ...
    eqn__constraints.append(
        boolean_value(block_size, right_shift(e[3], 6), right_shift(e[3], 11), right_shift(e[3], 25), # 14, 18, 41 in SHA512
                      in_var_b[0], "XOR"))
    ...
    # computer ai
    eqn__constraints.append(
        boolean_value(block_size, right_shift(a[3], 2), right_shift(a[3], 13), right_shift(a[3], 22), # 2, 13, 22 in SHA512
                      in_var_b[6], "XOR"))
