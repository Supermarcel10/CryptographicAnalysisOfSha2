...
(define-fun delta_w16 () Word (expandMessage delta_w0 delta_w1 delta_w9 delta_w14))(define-fun delta_w17 () Word (expandMessage delta_w1 delta_w2 delta_w10 delta_w15))(define-fun delta_w18 () Word (expandMessage delta_w2 delta_w3 delta_w11 delta_w16))(define-fun delta_w19 () Word (expandMessage delta_w3 delta_w4 delta_w12 delta_w17))(define-fun delta_w20 () Word (expandMessage delta_w4 delta_w5 delta_w13 delta_w18))
...
(define-fun delta_hash0 () Word (bvadd delta_a0 delta_a21))
(define-fun delta_hash1 () Word (bvadd delta_b0 delta_b21))
(define-fun delta_hash2 () Word (bvadd delta_c0 delta_c21))
(define-fun delta_hash3 () Word (bvadd delta_d0 delta_d21))
(define-fun delta_hash4 () Word (bvadd delta_e0 delta_e21))
(define-fun delta_hash5 () Word (bvadd delta_f0 delta_f21))
(define-fun delta_hash6 () Word (bvadd delta_g0 delta_g21))
(define-fun delta_hash7 () Word (bvadd delta_h0 delta_h21))
