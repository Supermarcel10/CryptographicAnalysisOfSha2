...
(define-fun delta_hash0 () Word (bvadd delta_a0 delta_a6))
(define-fun delta_hash1 () Word (bvadd delta_b0 delta_b6))
(define-fun delta_hash2 () Word (bvadd delta_c0 delta_c6))
(define-fun delta_hash3 () Word (bvadd delta_d0 delta_d6))
(define-fun delta_hash4 () Word (bvadd delta_e0 delta_e6))
(define-fun delta_hash5 () Word (bvadd delta_f0 delta_f6))
(define-fun delta_hash6 () Word (bvadd delta_g0 delta_g6))
(define-fun delta_hash7 () Word (bvadd delta_h0 delta_h6))
...
;; GET OUTPUT
; Input message
(get-value (m0_w0 m1_w0 m0_w1 m1_w1 m0_w2 m1_w2 m0_w3 m1_w3 m0_w4 m1_w4 m0_w5 m1_w5))

; Output round A/E/W state changes
(get-value (delta_a0 delta_e0 delta_w0 delta_a1 delta_e1 delta_w1 delta_a2 delta_e2 delta_w2 delta_a3 delta_e3 delta_w3 delta_a4 delta_e4 delta_w4 delta_a5 delta_e5 delta_w5))
