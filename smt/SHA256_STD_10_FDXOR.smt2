...
; Message expansion irrelevant for 10 rounds
...
; Message expansion assertions irrelevant for 10 rounds
...
(define-fun delta_hash0 () Word (bvadd delta_a0 delta_a10))
(define-fun delta_hash1 () Word (bvadd delta_b0 delta_b10))
(define-fun delta_hash2 () Word (bvadd delta_c0 delta_c10))
(define-fun delta_hash3 () Word (bvadd delta_d0 delta_d10))
(define-fun delta_hash4 () Word (bvadd delta_e0 delta_e10))
(define-fun delta_hash5 () Word (bvadd delta_f0 delta_f10))
(define-fun delta_hash6 () Word (bvadd delta_g0 delta_g10))
(define-fun delta_hash7 () Word (bvadd delta_h0 delta_h10))
...
(get-value (delta_a0 delta_e0 delta_w0 delta_a1 delta_e1 delta_w1 delta_a2 delta_e2 delta_w2 delta_a3 delta_e3 delta_w3 delta_a4 delta_e4 delta_w4 delta_a5 delta_e5 delta_w5 delta_a6 delta_e6 delta_w6 delta_a7 delta_e7 delta_w7 delta_a8 delta_e8 delta_w8 delta_a9 delta_e9 delta_w9))
