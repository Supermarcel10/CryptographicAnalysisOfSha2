...
(define-fun delta_hash0 () Word (bvadd delta_a0 delta_a2))
(define-fun delta_hash1 () Word (bvadd delta_b0 delta_b2))
(define-fun delta_hash2 () Word (bvadd delta_c0 delta_c2))
(define-fun delta_hash3 () Word (bvadd delta_d0 delta_d2))
(define-fun delta_hash4 () Word (bvadd delta_e0 delta_e2))
(define-fun delta_hash5 () Word (bvadd delta_f0 delta_f2))
(define-fun delta_hash6 () Word (bvadd delta_g0 delta_g2))
(define-fun delta_hash7 () Word (bvadd delta_h0 delta_h2))
...
;; GET OUTPUT
; Input message
(get-value (m0_w0 m1_w0 m0_w1 m1_w1))

; Output round A/E/W state changes
(get-value (delta_a0 delta_e0 delta_w0 delta_a1 delta_e1 delta_w1))
