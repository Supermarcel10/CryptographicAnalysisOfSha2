...
(define-fun m0_w11 () Word #x0000000000000000) ; Irrelevant for 11 rounds
(define-fun m0_w12 () Word #x0000000000000000) ; Irrelevant for 11 rounds
(define-fun m0_w13 () Word #x0000000000000000) ; Irrelevant for 11 rounds
(define-fun m0_w14 () Word #x0000000000000000) ; Irrelevant for 11 rounds
(define-fun m0_w15 () Word #x0000000000000000) ; Irrelevant for 11 rounds
...
(define-fun m1_w11 () Word #x0000000000000000) ; Irrelevant for 11 rounds
(define-fun m1_w12 () Word #x0000000000000000) ; Irrelevant for 11 rounds
(define-fun m1_w13 () Word #x0000000000000000) ; Irrelevant for 11 rounds
(define-fun m1_w14 () Word #x0000000000000000) ; Irrelevant for 11 rounds
(define-fun m1_w15 () Word #x0000000000000000) ; Irrelevant for 11 rounds
; Message expansion irrelevant for 11 rounds
