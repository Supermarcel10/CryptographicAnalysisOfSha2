...
; Final state update
(define-fun m0_hash0 () Word (bvadd a0 m0_a6))
(define-fun m1_hash0 () Word (bvadd a0 m1_a6))
(define-fun m0_hash1 () Word (bvadd b0 m0_b6))
(define-fun m1_hash1 () Word (bvadd b0 m1_b6))
(define-fun m0_hash2 () Word (bvadd c0 m0_c6))
(define-fun m1_hash2 () Word (bvadd c0 m1_c6))
(define-fun m0_hash3 () Word (bvadd d0 m0_d6))
(define-fun m1_hash3 () Word (bvadd d0 m1_d6))
(define-fun m0_hash4 () Word (bvadd e0 m0_e6))
(define-fun m1_hash4 () Word (bvadd e0 m1_e6))
(define-fun m0_hash5 () Word (bvadd f0 m0_f6))
(define-fun m1_hash5 () Word (bvadd f0 m1_f6))
(define-fun m0_hash6 () Word (bvadd g0 m0_g6))
(define-fun m1_hash6 () Word (bvadd g0 m1_g6))
(define-fun m0_hash7 () Word (bvadd h0 m0_h6))
(define-fun m1_hash7 () Word (bvadd h0 m1_h6))
