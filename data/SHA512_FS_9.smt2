...
(define-const k1 Word #x7137449123ef65cd)
(define-const k2 Word #xb5c0fbcfec4d3b2f)
(define-const k3 Word #xe9b5dba58189dbbc)
(define-const k4 Word #x3956c25bf348b538)
(define-const k5 Word #x59f111f1b605d019)
(define-const k6 Word #x923f82a4af194f9b)
(define-const k7 Word #xab1c5ed5da6d8118)
(define-const k8 Word #xd807aa98a3030242)

; Define H constants (IV/CV)
(declare-const m0_a0 Word)
(declare-const m1_a0 Word)
(declare-const m0_b0 Word)
(declare-const m1_b0 Word)
(declare-const m0_c0 Word)
(declare-const m1_c0 Word)
(declare-const m0_d0 Word)
(declare-const m1_d0 Word)
(declare-const m0_e0 Word)
(declare-const m1_e0 Word)
(declare-const m0_f0 Word)
(declare-const m1_f0 Word)
(declare-const m0_g0 Word)
(declare-const m1_g0 Word)
(declare-const m0_h0 Word)
(declare-const m1_h0 Word)
...
(declare-const m0_w4 Word)
(declare-const m0_w5 Word)
(declare-const m0_w6 Word)
(declare-const m0_w7 Word)
(declare-const m0_w8 Word)
(define-const m0_w9 Word #x0000000000000000) ; Irrelevant for 9 rounds
(define-const m0_w10 Word #x0000000000000000) ; Irrelevant for 9 rounds
(define-const m0_w11 Word #x0000000000000000) ; Irrelevant for 9 rounds
(define-const m0_w12 Word #x0000000000000000) ; Irrelevant for 9 rounds
(define-const m0_w13 Word #x0000000000000000) ; Irrelevant for 9 rounds
(define-const m0_w14 Word #x0000000000000000) ; Irrelevant for 9 rounds
(define-const m0_w15 Word #x0000000000000000) ; Irrelevant for 9 rounds
...
(declare-const m1_w4 Word)
(declare-const m1_w5 Word)
(declare-const m1_w6 Word)
(declare-const m1_w7 Word)
(declare-const m1_w8 Word)
(define-const m1_w9 Word #x0000000000000000) ; Irrelevant for 9 rounds
(define-const m1_w10 Word #x0000000000000000) ; Irrelevant for 9 rounds
(define-const m1_w11 Word #x0000000000000000) ; Irrelevant for 9 rounds
(define-const m1_w12 Word #x0000000000000000) ; Irrelevant for 9 rounds
(define-const m1_w13 Word #x0000000000000000) ; Irrelevant for 9 rounds
(define-const m1_w14 Word #x0000000000000000) ; Irrelevant for 9 rounds
(define-const m1_w15 Word #x0000000000000000) ; Irrelevant for 9 rounds
; Message expansion irrelevant for 9 rounds
...
(define-fun m0_e1 () Word (bvadd m0_d1 m0_t1_1))
...
(define-fun m0_e2 () Word (bvadd m0_d2 m0_t1_2))
...
(define-fun m0_e3 () Word (bvadd m0_d3 m0_t1_3))
...
(define-fun m0_e4 () Word (bvadd m0_d4 m0_t1_4))
...
(define-fun m0_e5 () Word (bvadd m0_d5 m0_t1_5))
...
(define-fun m0_e6 () Word (bvadd m0_d6 m0_t1_6))
...
(define-fun m0_e7 () Word (bvadd m0_d7 m0_t1_7))
...
(define-fun m0_e8 () Word (bvadd m0_d8 m0_t1_8))
...
(define-fun m0_e9 () Word (bvadd m0_d9 m0_t1_9))
...
(define-fun m1_e1 () Word (bvadd m1_d1 m1_t1_1))
...
(define-fun m1_e2 () Word (bvadd m1_d2 m1_t1_2))
...
(define-fun m1_e3 () Word (bvadd m1_d3 m1_t1_3))
...
(define-fun m1_e4 () Word (bvadd m1_d4 m1_t1_4))
...
(define-fun m1_e5 () Word (bvadd m1_d5 m1_t1_5))
...
(define-fun m1_e6 () Word (bvadd m1_d6 m1_t1_6))
...
(define-fun m1_e7 () Word (bvadd m1_d7 m1_t1_7))
...
(define-fun m1_e8 () Word (bvadd m1_d8 m1_t1_8))
...
(define-fun m1_e9 () Word (bvadd m1_d9 m1_t1_9))
(define-fun m1_f9 () Word m1_e8)
(define-fun m1_g9 () Word m1_f8)
(define-fun m1_h9 () Word m1_g8)

; Final state update
(define-fun m0_hash0 () Word (bvadd m0_a0 m0_a9))
(define-fun m1_hash0 () Word (bvadd m1_a0 m1_a9))
(define-fun m0_hash1 () Word (bvadd m0_b0 m0_b9))
(define-fun m1_hash1 () Word (bvadd m1_b0 m1_b9))
(define-fun m0_hash2 () Word (bvadd m0_c0 m0_c9))
(define-fun m1_hash2 () Word (bvadd m1_c0 m1_c9))
(define-fun m0_hash3 () Word (bvadd m0_d0 m0_d9))
(define-fun m1_hash3 () Word (bvadd m1_d0 m1_d9))
(define-fun m0_hash4 () Word (bvadd m0_e0 m0_e9))
(define-fun m1_hash4 () Word (bvadd m1_e0 m1_e9))
(define-fun m0_hash5 () Word (bvadd m0_f0 m0_f9))
(define-fun m1_hash5 () Word (bvadd m1_f0 m1_f9))
(define-fun m0_hash6 () Word (bvadd m0_g0 m0_g9))
(define-fun m1_hash6 () Word (bvadd m1_g0 m1_g9))
(define-fun m0_hash7 () Word (bvadd m0_h0 m0_h9))
(define-fun m1_hash7 () Word (bvadd m1_h0 m1_h9))
