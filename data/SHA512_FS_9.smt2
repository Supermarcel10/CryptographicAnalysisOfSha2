...
(define-fun k7 () Word #xab1c5ed5da6d8118)
(define-fun k8 () Word #xd807aa98a3030242)
...
(define-fun m0_w9 () Word #x0000000000000000) ; Irrelevant for 9 rounds
(define-fun m0_w10 () Word #x0000000000000000) ; Irrelevant for 9 rounds
(define-fun m0_w11 () Word #x0000000000000000) ; Irrelevant for 9 rounds
(define-fun m0_w12 () Word #x0000000000000000) ; Irrelevant for 9 rounds
(define-fun m0_w13 () Word #x0000000000000000) ; Irrelevant for 9 rounds
(define-fun m0_w14 () Word #x0000000000000000) ; Irrelevant for 9 rounds
(define-fun m0_w15 () Word #x0000000000000000) ; Irrelevant for 9 rounds
...
(define-fun m1_w9 () Word #x0000000000000000) ; Irrelevant for 9 rounds
(define-fun m1_w10 () Word #x0000000000000000) ; Irrelevant for 9 rounds
(define-fun m1_w11 () Word #x0000000000000000) ; Irrelevant for 9 rounds
(define-fun m1_w12 () Word #x0000000000000000) ; Irrelevant for 9 rounds
(define-fun m1_w13 () Word #x0000000000000000) ; Irrelevant for 9 rounds
(define-fun m1_w14 () Word #x0000000000000000) ; Irrelevant for 9 rounds
(define-fun m1_w15 () Word #x0000000000000000) ; Irrelevant for 9 rounds
; Message expansion irrelevant for 9 rounds
