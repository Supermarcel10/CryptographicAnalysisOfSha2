...
(define-fun m0_w5 () Word #x00000000) ; Irrelevant for 5 rounds
(define-fun m0_w6 () Word #x00000000) ; Irrelevant for 5 rounds
(define-fun m0_w7 () Word #x00000000) ; Irrelevant for 5 rounds
(define-fun m0_w8 () Word #x00000000) ; Irrelevant for 5 rounds
(define-fun m0_w9 () Word #x00000000) ; Irrelevant for 5 rounds
(define-fun m0_w10 () Word #x00000000) ; Irrelevant for 5 rounds
(define-fun m0_w11 () Word #x00000000) ; Irrelevant for 5 rounds
(define-fun m0_w12 () Word #x00000000) ; Irrelevant for 5 rounds
(define-fun m0_w13 () Word #x00000000) ; Irrelevant for 5 rounds
(define-fun m0_w14 () Word #x00000000) ; Irrelevant for 5 rounds
(define-fun m0_w15 () Word #x00000000) ; Irrelevant for 5 rounds
; Message expansion irrelevant for 5 rounds
...
(define-fun delta_w5 () Word #x00000000) ; Irrelevant for 5 rounds
(define-fun delta_w6 () Word #x00000000) ; Irrelevant for 5 rounds
(define-fun delta_w7 () Word #x00000000) ; Irrelevant for 5 rounds
(define-fun delta_w8 () Word #x00000000) ; Irrelevant for 5 rounds
(define-fun delta_w9 () Word #x00000000) ; Irrelevant for 5 rounds
(define-fun delta_w10 () Word #x00000000) ; Irrelevant for 5 rounds
(define-fun delta_w11 () Word #x00000000) ; Irrelevant for 5 rounds
(define-fun delta_w12 () Word #x00000000) ; Irrelevant for 5 rounds
(define-fun delta_w13 () Word #x00000000) ; Irrelevant for 5 rounds
(define-fun delta_w14 () Word #x00000000) ; Irrelevant for 5 rounds
(define-fun delta_w15 () Word #x00000000) ; Irrelevant for 5 rounds
...
(define-fun m1_w5 () Word (bvxor m0_w5 delta_w5)) ; Irrelevant for 5 rounds
(define-fun m1_w6 () Word (bvxor m0_w6 delta_w6)) ; Irrelevant for 5 rounds
(define-fun m1_w7 () Word (bvxor m0_w7 delta_w7)) ; Irrelevant for 5 rounds
(define-fun m1_w8 () Word (bvxor m0_w8 delta_w8)) ; Irrelevant for 5 rounds
(define-fun m1_w9 () Word (bvxor m0_w9 delta_w9)) ; Irrelevant for 5 rounds
(define-fun m1_w10 () Word (bvxor m0_w10 delta_w10)) ; Irrelevant for 5 rounds
(define-fun m1_w11 () Word (bvxor m0_w11 delta_w11)) ; Irrelevant for 5 rounds
(define-fun m1_w12 () Word (bvxor m0_w12 delta_w12)) ; Irrelevant for 5 rounds
(define-fun m1_w13 () Word (bvxor m0_w13 delta_w13)) ; Irrelevant for 5 rounds
(define-fun m1_w14 () Word (bvxor m0_w14 delta_w14)) ; Irrelevant for 5 rounds
(define-fun m1_w15 () Word (bvxor m0_w15 delta_w15)) ; Irrelevant for 5 rounds
...
; Final state update
(define-fun m0_hash0 () Word (bvadd a0 m0_a5))
(define-fun m1_hash0 () Word (bvadd a0 m1_a5))
(define-fun m0_hash1 () Word (bvadd b0 m0_b5))
(define-fun m1_hash1 () Word (bvadd b0 m1_b5))
(define-fun m0_hash2 () Word (bvadd c0 m0_c5))
(define-fun m1_hash2 () Word (bvadd c0 m1_c5))
(define-fun m0_hash3 () Word (bvadd d0 m0_d5))
(define-fun m1_hash3 () Word (bvadd d0 m1_d5))
(define-fun m0_hash4 () Word (bvadd e0 m0_e5))
(define-fun m1_hash4 () Word (bvadd e0 m1_e5))
(define-fun m0_hash5 () Word (bvadd f0 m0_f5))
(define-fun m1_hash5 () Word (bvadd f0 m1_f5))
(define-fun m0_hash6 () Word (bvadd g0 m0_g5))
(define-fun m1_hash6 () Word (bvadd g0 m1_g5))
(define-fun m0_hash7 () Word (bvadd h0 m0_h5))
(define-fun m1_hash7 () Word (bvadd h0 m1_h5))
...
(get-value (a0 e0 m0_w0 m1_w0 m0_a1 m1_a1 m0_e1 m1_e1 m0_w1 m1_w1 m0_a2 m1_a2 m0_e2 m1_e2 m0_w2 m1_w2 m0_a3 m1_a3 m0_e3 m1_e3 m0_w3 m1_w3 m0_a4 m1_a4 m0_e4 m1_e4 m0_w4 m1_w4 m0_a5 m1_a5 m0_e5 m1_e5 m0_w5 m1_w5))
