...
(define-fun m0_w2 () Word #x0000000000000000) ; Irrelevant for 2 rounds
(define-fun m0_w3 () Word #x0000000000000000) ; Irrelevant for 2 rounds
(define-fun m0_w4 () Word #x0000000000000000) ; Irrelevant for 2 rounds
(define-fun m0_w5 () Word #x0000000000000000) ; Irrelevant for 2 rounds
(define-fun m0_w6 () Word #x0000000000000000) ; Irrelevant for 2 rounds
(define-fun m0_w7 () Word #x0000000000000000) ; Irrelevant for 2 rounds
(define-fun m0_w8 () Word #x0000000000000000) ; Irrelevant for 2 rounds
(define-fun m0_w9 () Word #x0000000000000000) ; Irrelevant for 2 rounds
(define-fun m0_w10 () Word #x0000000000000000) ; Irrelevant for 2 rounds
(define-fun m0_w11 () Word #x0000000000000000) ; Irrelevant for 2 rounds
(define-fun m0_w12 () Word #x0000000000000000) ; Irrelevant for 2 rounds
(define-fun m0_w13 () Word #x0000000000000000) ; Irrelevant for 2 rounds
(define-fun m0_w14 () Word #x0000000000000000) ; Irrelevant for 2 rounds
(define-fun m0_w15 () Word #x0000000000000000) ; Irrelevant for 2 rounds
...
(define-fun m1_w2 () Word #x0000000000000000) ; Irrelevant for 2 rounds
(define-fun m1_w3 () Word #x0000000000000000) ; Irrelevant for 2 rounds
(define-fun m1_w4 () Word #x0000000000000000) ; Irrelevant for 2 rounds
(define-fun m1_w5 () Word #x0000000000000000) ; Irrelevant for 2 rounds
(define-fun m1_w6 () Word #x0000000000000000) ; Irrelevant for 2 rounds
(define-fun m1_w7 () Word #x0000000000000000) ; Irrelevant for 2 rounds
(define-fun m1_w8 () Word #x0000000000000000) ; Irrelevant for 2 rounds
(define-fun m1_w9 () Word #x0000000000000000) ; Irrelevant for 2 rounds
(define-fun m1_w10 () Word #x0000000000000000) ; Irrelevant for 2 rounds
(define-fun m1_w11 () Word #x0000000000000000) ; Irrelevant for 2 rounds
(define-fun m1_w12 () Word #x0000000000000000) ; Irrelevant for 2 rounds
(define-fun m1_w13 () Word #x0000000000000000) ; Irrelevant for 2 rounds
(define-fun m1_w14 () Word #x0000000000000000) ; Irrelevant for 2 rounds
(define-fun m1_w15 () Word #x0000000000000000) ; Irrelevant for 2 rounds
; Message expansion irrelevant for 2 rounds
