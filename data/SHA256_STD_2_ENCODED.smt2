...
(define-fun m0_w2 () Word #x00000000) ; Irrelevant for 2 rounds
(define-fun m0_w3 () Word #x00000000) ; Irrelevant for 2 rounds
(define-fun m0_w4 () Word #x00000000) ; Irrelevant for 2 rounds
(define-fun m0_w5 () Word #x00000000) ; Irrelevant for 2 rounds
(define-fun m0_w6 () Word #x00000000) ; Irrelevant for 2 rounds
(define-fun m0_w7 () Word #x00000000) ; Irrelevant for 2 rounds
(define-fun m0_w8 () Word #x00000000) ; Irrelevant for 2 rounds
(define-fun m0_w9 () Word #x00000000) ; Irrelevant for 2 rounds
(define-fun m0_w10 () Word #x00000000) ; Irrelevant for 2 rounds
(define-fun m0_w11 () Word #x00000000) ; Irrelevant for 2 rounds
(define-fun m0_w12 () Word #x00000000) ; Irrelevant for 2 rounds
(define-fun m0_w13 () Word #x00000000) ; Irrelevant for 2 rounds
(define-fun m0_w14 () Word #x00000000) ; Irrelevant for 2 rounds
(define-fun m0_w15 () Word #x00000000) ; Irrelevant for 2 rounds
; Message expansion irrelevant for 2 rounds

; Message Differential (W)
(declare-fun delta_w0 () Word)
(declare-fun delta_w1 () Word)
(define-fun delta_w2 () Word #x00000000) ; Irrelevant for 2 rounds
(define-fun delta_w3 () Word #x00000000) ; Irrelevant for 2 rounds
(define-fun delta_w4 () Word #x00000000) ; Irrelevant for 2 rounds
(define-fun delta_w5 () Word #x00000000) ; Irrelevant for 2 rounds
(define-fun delta_w6 () Word #x00000000) ; Irrelevant for 2 rounds
(define-fun delta_w7 () Word #x00000000) ; Irrelevant for 2 rounds
(define-fun delta_w8 () Word #x00000000) ; Irrelevant for 2 rounds
(define-fun delta_w9 () Word #x00000000) ; Irrelevant for 2 rounds
(define-fun delta_w10 () Word #x00000000) ; Irrelevant for 2 rounds
(define-fun delta_w11 () Word #x00000000) ; Irrelevant for 2 rounds
(define-fun delta_w12 () Word #x00000000) ; Irrelevant for 2 rounds
(define-fun delta_w13 () Word #x00000000) ; Irrelevant for 2 rounds
(define-fun delta_w14 () Word #x00000000) ; Irrelevant for 2 rounds
(define-fun delta_w15 () Word #x00000000) ; Irrelevant for 2 rounds

; MESSAGE 1 (Derived)
(define-fun m1_w0 () Word (bvxor m0_w0 delta_w0))
(define-fun m1_w1 () Word (bvxor m0_w1 delta_w1))
(define-fun m1_w2 () Word (bvxor m0_w2 delta_w2)) ; Irrelevant for 2 rounds
(define-fun m1_w3 () Word (bvxor m0_w3 delta_w3)) ; Irrelevant for 2 rounds
(define-fun m1_w4 () Word (bvxor m0_w4 delta_w4)) ; Irrelevant for 2 rounds
(define-fun m1_w5 () Word (bvxor m0_w5 delta_w5)) ; Irrelevant for 2 rounds
...
; Final state update
(define-fun m0_hash0 () Word (bvadd a0 m0_a2))
(define-fun m1_hash0 () Word (bvadd a0 m1_a2))
(define-fun m0_hash1 () Word (bvadd b0 m0_b2))
(define-fun m1_hash1 () Word (bvadd b0 m1_b2))
(define-fun m0_hash2 () Word (bvadd c0 m0_c2))
(define-fun m1_hash2 () Word (bvadd c0 m1_c2))
(define-fun m0_hash3 () Word (bvadd d0 m0_d2))
(define-fun m1_hash3 () Word (bvadd d0 m1_d2))
(define-fun m0_hash4 () Word (bvadd e0 m0_e2))
(define-fun m1_hash4 () Word (bvadd e0 m1_e2))
(define-fun m0_hash5 () Word (bvadd f0 m0_f2))
(define-fun m1_hash5 () Word (bvadd f0 m1_f2))
(define-fun m0_hash6 () Word (bvadd g0 m0_g2))
(define-fun m1_hash6 () Word (bvadd g0 m1_g2))
(define-fun m0_hash7 () Word (bvadd h0 m0_h2))
(define-fun m1_hash7 () Word (bvadd h0 m1_h2))
...
(get-value (a0 e0 m0_w0 m1_w0 m0_a1 m1_a1 m0_e1 m1_e1 m0_w1 m1_w1 m0_a2 m1_a2 m0_e2 m1_e2 m0_w2 m1_w2))
