...
(define-const m0_w5 Word #x0000000000000000) ; Irrelevant for 5 rounds
(define-const m0_w6 Word #x0000000000000000) ; Irrelevant for 5 rounds
(define-const m0_w7 Word #x0000000000000000) ; Irrelevant for 5 rounds
(define-const m0_w8 Word #x0000000000000000) ; Irrelevant for 5 rounds
(define-const m0_w9 Word #x0000000000000000) ; Irrelevant for 5 rounds
(define-const m0_w10 Word #x0000000000000000) ; Irrelevant for 5 rounds
(define-const m0_w11 Word #x0000000000000000) ; Irrelevant for 5 rounds
(define-const m0_w12 Word #x0000000000000000) ; Irrelevant for 5 rounds
(define-const m0_w13 Word #x0000000000000000) ; Irrelevant for 5 rounds
(define-const m0_w14 Word #x0000000000000000) ; Irrelevant for 5 rounds
(define-const m0_w15 Word #x0000000000000000) ; Irrelevant for 5 rounds
...
(define-const m1_w5 Word #x0000000000000000) ; Irrelevant for 5 rounds
(define-const m1_w6 Word #x0000000000000000) ; Irrelevant for 5 rounds
(define-const m1_w7 Word #x0000000000000000) ; Irrelevant for 5 rounds
(define-const m1_w8 Word #x0000000000000000) ; Irrelevant for 5 rounds
(define-const m1_w9 Word #x0000000000000000) ; Irrelevant for 5 rounds
(define-const m1_w10 Word #x0000000000000000) ; Irrelevant for 5 rounds
(define-const m1_w11 Word #x0000000000000000) ; Irrelevant for 5 rounds
(define-const m1_w12 Word #x0000000000000000) ; Irrelevant for 5 rounds
(define-const m1_w13 Word #x0000000000000000) ; Irrelevant for 5 rounds
(define-const m1_w14 Word #x0000000000000000) ; Irrelevant for 5 rounds
(define-const m1_w15 Word #x0000000000000000) ; Irrelevant for 5 rounds
; Message expansion irrelevant for 5 rounds
...
; Final state update
(define-fun m0_hash0 () Word (bvadd m0_a0 m0_a5))
(define-fun m1_hash0 () Word (bvadd m1_a0 m1_a5))
(define-fun m0_hash1 () Word (bvadd m0_b0 m0_b5))
(define-fun m1_hash1 () Word (bvadd m1_b0 m1_b5))
(define-fun m0_hash2 () Word (bvadd m0_c0 m0_c5))
(define-fun m1_hash2 () Word (bvadd m1_c0 m1_c5))
(define-fun m0_hash3 () Word (bvadd m0_d0 m0_d5))
(define-fun m1_hash3 () Word (bvadd m1_d0 m1_d5))
(define-fun m0_hash4 () Word (bvadd m0_e0 m0_e5))
(define-fun m1_hash4 () Word (bvadd m1_e0 m1_e5))
(define-fun m0_hash5 () Word (bvadd m0_f0 m0_f5))
(define-fun m1_hash5 () Word (bvadd m1_f0 m1_f5))
(define-fun m0_hash6 () Word (bvadd m0_g0 m0_g5))
(define-fun m1_hash6 () Word (bvadd m1_g0 m1_g5))
(define-fun m0_hash7 () Word (bvadd m0_h0 m0_h5))
(define-fun m1_hash7 () Word (bvadd m1_h0 m1_h5))
...
(get-value (m0_a0 m1_a0 m0_e0 m1_e0 m0_w0 m1_w0 m0_a1 m1_a1 m0_e1 m1_e1 m0_w1 m1_w1 m0_a2 m1_a2 m0_e2 m1_e2 m0_w2 m1_w2 m0_a3 m1_a3 m0_e3 m1_e3 m0_w3 m1_w3 m0_a4 m1_a4 m0_e4 m1_e4 m0_w4 m1_w4 m0_a5 m1_a5 m0_e5 m1_e5 m0_w5 m1_w5))
