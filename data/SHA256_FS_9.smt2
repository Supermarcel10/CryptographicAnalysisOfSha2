...
(define-const k4 Word #x3956c25b)
(define-const k5 Word #x59f111f1)
(define-const k6 Word #x923f82a4)
(define-const k7 Word #xab1c5ed5)
(define-const k8 Word #xd807aa98)
...
(define-const m0_w9 Word #x00000000) ; Irrelevant for 9 rounds
(define-const m0_w10 Word #x00000000) ; Irrelevant for 9 rounds
(define-const m0_w11 Word #x00000000) ; Irrelevant for 9 rounds
(define-const m0_w12 Word #x00000000) ; Irrelevant for 9 rounds
(define-const m0_w13 Word #x00000000) ; Irrelevant for 9 rounds
(define-const m0_w14 Word #x00000000) ; Irrelevant for 9 rounds
(define-const m0_w15 Word #x00000000) ; Irrelevant for 9 rounds
...
(define-const m1_w9 Word #x00000000) ; Irrelevant for 9 rounds
(define-const m1_w10 Word #x00000000) ; Irrelevant for 9 rounds
(define-const m1_w11 Word #x00000000) ; Irrelevant for 9 rounds
(define-const m1_w12 Word #x00000000) ; Irrelevant for 9 rounds
(define-const m1_w13 Word #x00000000) ; Irrelevant for 9 rounds
(define-const m1_w14 Word #x00000000) ; Irrelevant for 9 rounds
(define-const m1_w15 Word #x00000000) ; Irrelevant for 9 rounds
; Message expansion irrelevant for 9 rounds
